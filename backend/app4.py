...
VISION_API_KEY = "your_vision_api_key_here"  # 🔒 Replace this with your actual Vision API key
...
# Nebius client removed — /generate-text now reuses the Groq client (see top of file)
